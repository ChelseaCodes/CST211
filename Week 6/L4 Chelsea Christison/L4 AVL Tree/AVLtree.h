...
private:
	...
	void FindNodeToDelete(T data, tree_node<T> *& root, bool& shorter); 
	void Delete(tree_node<T> *& parent, bool& shorter); 
...
*
* Precondition:
*	data - data to be removed from the AVLTree
* Postcondition:
*	modifies root if deleted data. 
************************************************************************/
template <typename T>
void AVLTree<T>::Delete(T data)
{
	bool shorter = false;
	bool success = false; 
	FindNodeToDelete(data, root, shorter);
}
...
/**********************************************************************
* Purpose:
*	This function traverses the AVLTree in pre order beginning with
*	root and traversing down the left side, and then the right. 
*
* Precondition:
*	_output - a function pointer to a function that handles display of
*				node.
* Postcondition:
*  outputs the AVL tree in pre order
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function traverses the AVLTree in post order. 
*
* Precondition:
*	_output - a function pointer to a function that handles display of
*				node.
* Postcondition:
*  outputs the AVL tree in post order
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function traverses the AVLTree in breadth first order. 
*	outputs each level of nodes in the tree
*
* Precondition:
*	_output - a function pointer to a function that handles display of
*				node.
* Postcondition:
*  outputs the AVL tree breadth first
************************************************************************/
template <typename T>
...
* Precondition:
*	root - node to perform rotation on 
* Postcondition:
*  rotates the root and its left child to be balanced
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function performs a right rotation on the root passed
*
* Precondition:
*	root - node to perform rotation on 
* Postcondition:
*	rotates the root and its right child to be balanced 
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function manages balance factors of nodes on the right of 
*	the passed root, and performs single and double rotations 
*	when applicable.
*
* Precondition:
*	root - root to balance 
*	taller - a boolean flag used for checking balance factor
* Postcondition:
*	balances the AVL tree with an RR or RL rotation 
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function recursively traverses the tree to find the node to 
*	delete. 
*
* Precondition:
*	data -	the data to be deleted 
*	root -	root of the tree to look in 
*	shorter - bool flag used to balance the tree after a deletion
*	
* Postcondition:
*	calls Delete and rebalanced the tree if deletion caused a shorter 
*	tree
************************************************************************/
template <typename T>
void AVLTree<T>::FindNodeToDelete(T data, tree_node<T> *& root, bool& shorter)
{
	if (!root)
		throw Exception("Empty Tree");
	...
	if (data < root->data)
	{
		FindNodeToDelete(data, root->left,shorter);
	...
	{
		FindNodeToDelete(data, root->right, shorter);
...
/**********************************************************************
* Purpose:
*	This function removes the parent node from the tree and indicates
*	the tree should be rebalanced 
*
* Precondition:
*	parent - node to be removed 
*	shorter - bool flag used to balance the tree after a deletion
* Postcondition:
*	removes a node from the tree 
************************************************************************/
template <typename T>
void AVLTree<T>::Delete(tree_node<T> *& parent, bool& shorter)
{
...
*
* Precondition:
*	root - node to begin balance 
*	shorter - bool to set for continuing balancing up the tree
* Postcondition:
*	balances the tree and sets nodes balance factors 
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function balances the left side of root after a delete
*
* Precondition:
*	root - node to begin balance 
*	shorter - bool to set for continuing balancing up the tree
...
/**********************************************************************
* Purpose:
*	This function purges the tree of all nodes and frees memory
*
* Precondition:
*	root - root to begin purge 
* Postcondition:
*	nullifies the tree 
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function recursively finds the height of the tree, given the 
*	parent. 
*
* Precondition:
*	parent - root to begin counting height
* Postcondition:
...
/**********************************************************************
* Purpose:
*	This function traverses and outputs the tree in order
* Precondition:
*	parent -  node to begin traversal 
*	visit -  function pointer to call for output 
* Postcondition:
...
/**********************************************************************
* Purpose:
*	This function traverses and outputs in pre order
* Precondition:
*   parent -  node to begin traversal 
*	visit -  function pointer to call for output 
* Postcondition:
...
/**********************************************************************
* Purpose:
*	This function traverses and outputs in post order 
* Precondition:
*	parent -  node to begin traversal 
*	visit -  function pointer to call for output 
* Postcondition:
*	outputs tree in postorder
************************************************************************/
template <typename T>
...
/**********************************************************************
* Purpose:
*	This function traverses and outputs in breadth first order
* Precondition:
*	parent -  node to begin traversal 
*	visit -  function pointer to call for output 
* Postcondition:
*	outputs tree in breadth first order
************************************************************************/
template <typename T>
